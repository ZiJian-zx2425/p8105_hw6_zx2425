...
```
    ...
    ##         0.119048         -0.003009          0.778832         -0.757727  
    ## 
    ## Degrees of Freedom: 1381 Total (i.e. Null);  1378 Residual
    ## Null Deviance:       1794 
    ## Residual Deviance: 1762  AIC: 1770
...
|:-----------------|-------:|------:|--------:|---------:|----------:|
| (Intercept)      |  0.119 | 1.126 |   0.627 |    0.697 |     1.821 |
| victim_age       | -0.003 | 0.997 |   0.508 |    0.988 |     1.006 |
| victim_raceWhite |  0.779 | 2.179 |   0.001 |    1.364 |     3.482 |
...
have smaller rmse than model_lg. This shows that model_bl, model_all are
better than model model_lg.
